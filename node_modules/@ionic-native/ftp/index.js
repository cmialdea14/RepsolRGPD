...
var FTP = (function (_super) {
     ...
     */
    FTP.prototype.connect = function (hostname, username, password) {
        return;
    };
    /**
     ...
     * @return {Promise<any>} Returns a promise
     */
    FTP.prototype.mkdir = function (path) {
        return;
    };
    /**
     ...
     * @return {Promise<any>} Returns a promise
     */
    FTP.prototype.rmdir = function (path) {
        return;
    };
    /**
     ...
     * @return {Promise<any>} Returns a promise
     */
    FTP.prototype.rm = function (file) {
        return;
    };
    /**
     ...
     */
    FTP.prototype.upload = function (localFile, remoteFile) {
        return;
    };
    /**
     ...
     *                        The arg `0`, `0.1xx`, `0.2xx` ... `1` means the upload percent. When it reach `1`, means success.
     */
    FTP.prototype.download = function (localFile, remoteFile) {
        return;
    };
    /**
